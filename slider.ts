...
type NewISlider = Required<
  Omit<ISlider, "animationName" | "speed"> & Record<"speed", number>
>;

const customSliderOptions: NewISlider = {
  container: "id",
  numberOfSlides: 4,
  speed: 1100,
  direction: "horizontal",
...
function createCustomSlider(options: NewISlider): void {
